...
public class threeplayersActivity extends AppCompatActivity {
    ...
    CircleProgressBar scoreProgressBar1, scoreProgressBar2, scoreProgressBar3;
...
//        final Spinner spinner1 = (Spinner) findViewById(R.id.spinner1);
        ...
        final EditText pinput3 = (EditText) findViewById(R.id.player3_in);
        scoreProgressBar3 = (CircleProgressBar) findViewById(R.id.score_progress3);
...
//
        ...
        final ListView ls3 = (ListView) findViewById(R.id.player3_list);
        final ArrayList<String> l3 = new ArrayList<String>();
        final ArrayAdapter<String> adapter5 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, l3);
        ...
        scoreProgressBar3.setProgressFormatter(new CircleProgressBar.ProgressFormatter() {
            @Override
            public CharSequence format(int progress, int max) {
                return progress + "pt";
            }
        ...
        scoreProgressBar3.setMax(301);
        simulateProgress(score3, scoreProgressBar3);


        Button player1_btn = (Button) findViewById(R.id.player1_btn);
...
//                        mCustomProgressBar1.setProgress(scoore1);
                        ...
                        AlertDialog.Builder dlgAlert = new AlertDialog.Builder(threeplayersActivity.this);
...
//                                    pscoore2.setText(String.valueOf(score2));
        ...
        Button player3_btn = (Button) findViewById(R.id.player3_btn);
        player3_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (pinput3.getText().length() != 0) {
                    int temp = Integer.parseInt(pinput3.getText().toString());
                    if (score3 - temp >= 0) {
                        l3.add(pinput3.getText().toString());
                        // adapter3.add(pinput1.getText().toString());
                        ls3.setAdapter(adapter5);
                        // adapter3.notifyDataSetChanged();
...
//                        mCustomProgressBar1.setProgress(scoore1);
        ...
        pinput3.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    switch (keyCode) {
                        case KeyEvent.KEYCODE_DPAD_CENTER:
...
//                int progress = (int) animation.getAnimatedValue();
    ...
    public void getwiner() {
        ...
        if (score3 == 0) {
            AlertDialog.Builder dlgAlert = new AlertDialog.Builder(this);
            dlgAlert.setMessage("blue win's");
            dlgAlert.setTitle("Winer is");
            dlgAlert.setPositiveButton("OK", null);
            dlgAlert.setCancelable(true);
            dlgAlert.create().show();
